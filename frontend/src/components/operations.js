...
export class Operations {
    ...
    createTrElement(operation) {
        ...
        tdElement2.innerText = operation.category;
        const tdElement3 = document.createElement('td');
        tdElement3.innerText = operation.amount + '$';
        const tdElement4 = document.createElement('td');
        tdElement4.innerText = operation.date.replaceAll('-', '.');
        const tdElement5 = document.createElement('td');
        tdElement5.innerText = operation.comment;
